...
main_font = pygame.font.Font("/Users/tsangtszkin/4180/AIST2010/BLUE/Resource/Font/MASQUE__.ttf", 35)
number_font = pygame.font.Font("/Users/tsangtszkin/4180/AIST2010/BLUE/Resource/Font/Infinite.ttf", 35)
...
background = pygame.image.load("/Users/tsangtszkin/4180/AIST2010/BLUE/Resource/main_Background.jpg").convert()
...
while not done:
    ...
    screen.blit(main_font.render("Score",True,(0,0,0)), (600,500))
    screen.blit(main_font.render("Combo", True, (0, 0, 0)), (400,500))
    screen.blit(number_font.render(str(map.combo(0)), True, (0, 0, 0)), (400,550))
    screen.blit(number_font.render(str(map.score(0)), True, (0, 0, 0)), (600,550))
